  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-bold ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        destructive:
          "bg-destructive text-destructive-foreground shadow-[6px_6px_16px_rgba(239,68,68,0.3),inset_3px_3px_6px_rgba(255,255,255,0.4),inset_-3px_-3px_6px_rgba(0,0,0,0.2)] transition-all hover:scale-105 active:scale-95 dark:shadow-[6px_6px_16px_rgba(239,68,68,0.3),inset_3px_3px_6px_rgba(255,255,255,0.2),inset_-3px_-3px_6px_rgba(0,0,0,0.3)]",
        outline:
          "clay-btn border-none text-foreground",
        secondary:
          "clay-btn text-secondary-foreground",
