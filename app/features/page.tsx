        ...
        <main className="min-h-screen bg-[#FDFDFF] dark:bg-black overflow-hidden font-geist">
            ...
            <section className="pt-44 pb-20 px-4 container mx-auto text-center">
                ...
                <h1 className="text-5xl md:text-7xl font-black tracking-tight mb-8 text-zinc-900 dark:text-white">
                    The Complete <br /> <span className="text-blue-600">Career OS.</span>
                </h1>
                ...
                <div className="flex justify-center gap-4">
                    <Link href="/auth/signup">
                        <Button className="h-12 px-8 rounded-xl bg-blue-600 hover:bg-blue-700 text-white font-bold">Try It Free</Button>
                    </Link>
                    <Link href="#deep-dive">
                        <Button variant="ghost" className="h-12 px-8 rounded-xl">Learn More</Button>
                    </Link>
                </div>
            </section>
                ...
                <div className="container mx-auto px-4 max-w-6xl">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        <div className="space-y-8">
                            ...
                            <h2 className="text-4xl font-bold text-zinc-900 dark:text-white leading-tight">
                                Dynamic Roadmaps that <br /> <span className="text-blue-600">Adapt to You.</span>
                            </h2>
                ...
                <div className="container mx-auto px-4 max-w-6xl">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        ...
                        <div className="space-y-8 order-1 lg:order-2">
                            ...
                            <h2 className="text-4xl font-bold text-zinc-900 dark:text-white leading-tight">
                                Your 24/7 AI <br /> <span className="text-purple-600">Career Mentor.</span>
                            </h2>
                            <p className="text-lg text-zinc-500 leading-relaxed">
            ...
            <section className="py-24 bg-zinc-900 text-white">
                <div className="container mx-auto px-4">
                    <div className="text-center max-w-2xl mx-auto mb-16">
                        <h2 className="text-3xl font-bold mb-4">Everything else you need to win.</h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                        {[
                            ...
                            <div key={i} className="p-8 rounded-3xl bg-zinc-800/50 border border-zinc-700 hover:bg-zinc-800 transition-colors">
            ...
            <section className="py-32 container mx-auto px-4 max-w-4xl text-center">
                <h2 className="text-4xl font-bold mb-8">Ready to upgrade your career?</h2>
                <Link href="/auth/signup">
                    <Button className="h-14 px-12 rounded-2xl bg-white text-black hover:bg-zinc-200 text-lg font-bold">
                        Get Started Now
                    </Button>
                </Link>
            </section>
