...
import { Mail, Lock, ArrowRight, User, Eye, EyeOff, Wand2, Loader2, CheckCircle2 } from "lucide-react"
                        ...
                        {!linkSent ? (
                            ...
                            >
                                <div className="text-center space-y-2">
                                    <h1 className="text-3xl font-black tracking-tight text-[#0F172A] dark:text-white">Create Account</h1>
                                    <p className="text-zinc-500 text-sm font-medium">Elevate your career trajectory today</p>
                                </div>
                                ...
                                <form onSubmit={handleSignup} className="space-y-5">
                                    ...
                                    >
                                        {loading ? (
                                            ...
                                            <>
                                                {loginMethod === "password" ? "Create Account" : "Send Magic Link"}
                                ...
                                <p className="text-center text-[11px] text-zinc-400 font-black uppercase tracking-widest">
                                    ...
                                    <Link href="/auth/login" className="text-blue-500 hover:text-blue-600 border-b-2 border-blue-500/10 hover:border-blue-500 transition-all pb-0.5 ml-1">Sign In</Link>
                                </p>
                            </motion.div>
                        ) : (
                            <motion.div
